/*
  ...
  - A unique constraint covering the columns `[best_answered_id]` on the table `questions` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "questions_best_answered_id_key" ON "questions"("best_answered_id");

-- AddForeignKey
ALTER TABLE "questions" ADD CONSTRAINT "questions_best_answered_id_fkey" FOREIGN KEY ("best_answered_id") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
